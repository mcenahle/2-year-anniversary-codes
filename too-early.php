...
<head>
    ...
    <script src="https://2.mn.edu.kg/jquery-4.0.0.min.js"></script>
    ...
    <link href="https://2.mn.edu.kg/jumbotron.css" rel="stylesheet">
    <style>
        a {
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="https://2.mn.edu.kg/">博客 2 周年活动</a>
        </div>
    </div>
</nav>
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="card">
                ...
                <button class="btn btn-primary-participate btn-lg btn-block" data-toggle="modal"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="color:red; margin-top:10px;">未到活动开始时间（2026 年 2 月 10 日 08:00）</p>
            </div>
